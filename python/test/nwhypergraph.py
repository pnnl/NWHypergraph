...
newe, equal_class = h.collapse_edges(return_equivalence_class=True)
print(newe)
print(equal_class)

print('-- collapsing nodes with returning equal class')
newn, equal_class = h.collapse_nodes(return_equivalence_class=True)
print(newn)
print(equal_class)

print('-- collapsing nodes and edges with returning equal class')
new, equal_class = h.collapse_nodes_and_edges(return_equivalence_class=True)
print(new)
print(equal_class)